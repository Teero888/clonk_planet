...
BOOL C4MassMover::Corrosion(int dx, int dy)
	...
	if (MatValid(tmat))
		if ( (Game.Material.Map[Mat].Incindiary && Game.Material.Map[tmat].Extinguisher)
			|| ((Random(100) < Game.Material.Map[Mat].Corrosive) && (Random(100) < Game.Material.Map[tmat].Corrode)) )
				{
