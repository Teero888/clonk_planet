...
CStdConfigValue C4ConfigMap[] =

    {
        ...
        {CFG_String, "RXFontName", ofC4Cfg(General.RXFontName),
         (long)"Comic Sans MS"},
        {CFG_Integer, "RXFontSize", ofC4Cfg(General.RXFontSize), 10},
        {CFG_String, "FEFontName", ofC4Cfg(General.FEFontName),
         (long)"Comic Sans MS"},
        ...
        {CFG_String, "SaveScenarioFolder", ofC4Cfg(General.SaveScenarioFolder),
         0},
        ...
        {CFG_Integer, "SplitscreenDividers",
         ofC4Cfg(Graphics.SplitscreenDividers), 1},
        {CFG_Integer, "ShowPlayerInfoAlways",
         ofC4Cfg(Graphics.ShowPlayerInfoAlways), 1},
        ...
        {CFG_Integer, "ShowStartupMessages",
         ofC4Cfg(Graphics.ShowStartupMessages), 1},
        ...
        {CFG_Integer, "VerboseObjectLoading",
         ofC4Cfg(Graphics.VerboseObjectLoading), 0},
        ...
        {CFG_String, "LocalAddress", ofC4Cfg(Network.LocalAddress),
         (long)"Unknown"},
        ...
        {CFG_Integer, "NoReferenceRequest", ofC4Cfg(Network.NoReferenceRequest),
         0},
        {CFG_Integer, "AsynchronousControl",
         ofC4Cfg(Network.AsynchronousControl), 0},
        {CFG_String, "Comment", ofC4Cfg(Network.Comment), 0},

        {CFG_Integer, "MasterServerSignUp", ofC4Cfg(Network.MasterServerSignUp),
         0},
        {CFG_Integer, "MasterServerActive", ofC4Cfg(Network.MasterServerActive),
         0},
        {CFG_String, "MasterServerAddress",
         ofC4Cfg(Network.MasterServerAddress), (long)"www.clonk.de"},
        {CFG_String, "MasterServerDirectory", ofC4Cfg(Network.MasterServerPath),
         (long)"/cgi-bin/cpmaster.pl"},
        {CFG_Integer, "MasterKeepPeriod", ofC4Cfg(Network.MasterKeepPeriod),
         60},
        {CFG_Integer, "MasterReferencePeriod",
         ofC4Cfg(Network.MasterReferencePeriod), 120},
        ...
        {CFG_String, "EditorBitmap", ofC4Cfg(Explorer.EditorBitmap),
         (long)"MSPaint.exe"},
        {CFG_String, "EditorMusic", ofC4Cfg(Explorer.EditorMusic),
         (long)"MPlayer.exe"},
        {CFG_String, "EditorRichText", ofC4Cfg(Explorer.EditorRichText),
         (long)"Wordpad.exe"},
        {CFG_String, "EditorScript", ofC4Cfg(Explorer.EditorScript),
         (long)"Notepad.exe"},
        {CFG_String, "EditorText", ofC4Cfg(Explorer.EditorText),
         (long)"Notepad.exe"},
        {CFG_String, "EditorSound", ofC4Cfg(Explorer.EditorSound),
         (long)"MPlayer.exe"},
        {CFG_String, "EditorZip", ofC4Cfg(Explorer.EditorZip),
         (long)"WinZip32.exe"},
        {CFG_String, "EditorDefinition", ofC4Cfg(Explorer.EditorDefinition), 0},
        {CFG_String, "EditorHtml", ofC4Cfg(Explorer.EditorHtml),
         (long)"iexplore.exe"},
...
BOOL C4Config::IsRegistered(const char *szName, const char *szCode,
