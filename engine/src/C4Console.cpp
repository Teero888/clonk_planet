...
BOOL C4Console::FileSelect(char *szFilename, int iSize, const char *szFilter, DWORD dwFlags, BOOL fSave)
	{
	return FALSE;
	}
...
BOOL C4Console::RegisterConsoleWindowClass(HINSTANCE hInst)
	{
	return TRUE;
	}
