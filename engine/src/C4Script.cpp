...
BOOL FnExit(C4Thread *cthr, C4Object *pObj, 
...
BOOL FnSetCommand(C4Thread *cthr, C4Object *pObj, 
...
BOOL FnAddCommand(C4Thread *cthr, C4Object *pObj, 
									const char *szCommand, 
									C4Object *pTarget, int iTx, int iTy,
									C4Object *pTarget2,
									int iUpdateInterval,
...
BOOL FnAppendCommand(C4Thread *cthr, C4Object *pObj, 
										 const char *szCommand, 
										 C4Object *pTarget, int iTx, int iTy,
										 C4Object *pTarget2,
										 int iUpdateInterval,
...
int FnObjectCount( C4Thread *cthr,
									 C4ID id, 
...
int FnObjectCall(C4Thread *cthr, 
...
int FnDefinitionCall(C4Thread *cthr, 
