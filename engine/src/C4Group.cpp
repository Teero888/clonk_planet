...
BOOL C4Group::AddEntry(int status, BOOL childgroup,
                       const char *fname, long size, time_t time,
                       const char *entryname,
                       BYTE *membuf, BOOL fDeleteOnDisk, 
											 BOOL fHoldBuffer)
  {
...
BOOL C4Group::Add(const char *szName, void *pBuffer, int iSize, 
									BOOL fChild, BOOL fHoldBuffer)
  {
...
int C4Group::LoadEntry(const char *szEntryName, BYTE **lpbpBuf,
