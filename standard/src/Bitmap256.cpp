...
CBitmap256Info::CBitmap256Info() { Default(); }

BOOL CBitmap256Info::Valid() {
  if (Head.bfType != *((WORD *)"BM"))
    return FALSE;
...
int CBitmap256Info::FileBitsOffset() { return Head.bfOffBits - sizeof(CBitmap256Info); }
...
void CBitmap256Info::Default() { ZeroMem(this, sizeof(CBitmap256Info)); }
